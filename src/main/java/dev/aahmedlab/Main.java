 ...
 *
 * <p>Runs a fixed sequence of scenarios (basic get/put, eviction, update, capacity-one, access
 * order, large capacity, invalid capacity, clear) using {@code assert} statements, printing a check
 * mark per scenario.
 *
 * <p><b>Design Decisions:</b>
 *
 * <ul>
 *   <li><b>{@code assert}-based checks:</b> Keeps the driver dependency-free, but requires running
 *       the JVM with {@code -ea} (assertions enabled) for failures to surface.
 *   <li><b>Duplicated coverage:</b> These scenarios mirror the JUnit tests in {@code LRUTest}; this
 *       class exists for quick manual runs from the IDE.
 * </ul>
 */
public class Main {
