...
/**
 * A single-threaded TTL-based deduplicator that reports whether a key is being seen
 * for the first time within a configurable time-to-live window.
 * <p>
 * This class maintains two coordinated data structures:
 * <ul>
 *   <li>A {@link HashMap} mapping each key to the epoch second at which it was last first-seen</li>
 *   <li>A ring of {@link HashSet} buckets (one per second of TTL) used by {@link #sweeper()}
 ...
 *   <li><b>Lazy expiry in {@link #isFirstSeen(Object)}:</b> A key older than the TTL is treated
 *       as first-seen again even if the sweeper has not yet run.</li>
 ...
 * See {@link ConcurrentDeduplicator} for a concurrent variant.
 *
