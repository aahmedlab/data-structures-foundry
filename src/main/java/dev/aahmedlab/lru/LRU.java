...
/**
 * A single-threaded least-recently-used (LRU) cache with O(1) get and put operations and a fixed
 * maximum capacity.
 *
 ...
 * </ul>
 *
 * <p><b>Thread Safety:</b> This class is <em>not</em> thread-safe. See {@link ConcurrentLRU} for a
 * concurrent variant.
 */
public class LRU {
