...
/**
 * A doubly linked list node holding a key-value pair, used as the building block of the recency
 * list in {@link LRU} and {@link ThreadSafeLRU}.
 *
 * <p><b>Design Decisions:</b>
 *
 * <ul>
 *   <li><b>Immutable key:</b> The key never changes after construction, since it must stay
 *       consistent with the cache map entry pointing at this node.
 *   <li><b>Mutable value and links:</b> Values are updated in place on {@code put}, and {@code
 *       prev}/{@code next} are relinked as the node moves within the recency list.
 ...
 * synchronization (as {@link ThreadSafeLRU} does).
 *
