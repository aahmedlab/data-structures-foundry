...
public class TopKFrequentElementsTest {
    ...
    void testMultipleElementsWithDifferentFrequencies() {
        int K = 3;
        int[] result = topKFrequentElements.topKFrequentUsingHeap(new int[]{4,4,4,4,3,3,3,2,2,1}, K);
        Arrays.sort(result);
    ...
    void testMultipleElementsWithDifferentFrequenciesUsingBucket() {
        int K = 3;
        int[] result = topKFrequentElements.topKFrequentUsingBucket(new int[]{4,4,4,4,3,3,3,2,2,1}, K);
        Arrays.sort(result);
        assertArrayEquals(new int[]{2,3,4}, result);
    }
